...
import CadastroAlunoPage from "../../e2e/pages/CadastroAlunoPage";
...
When("preencho resultado da visão {string}", (valor) => {
  cadastroPage.preencherResultadoVisao(valor);
});

When("seleciono rechecagem de visão {string}", (valor) => {
  cadastroPage.selecionarRechecagemVisao(valor);
});
...
// NOTAS FINAIS
// ---------------------------------------------
When("preencho nota de leitura {string}", (nota) => {
  cadastroPage.preencherNotaLeitura(nota);
});

When("preencho nota de ciências {string}", (nota) => {
  cadastroPage.preencherNotaCiencias(nota);
});

When("preencho nota de estudos sociais {string}", (nota) => {
  cadastroPage.preencherNotaSociais(nota);
});

When("preencho nota de educação física {string}", (nota) => {
